  ...
  <div class="content-wrapper" style="background: linear-gradient(to bottom, rgba(255, 198, 219, 1), rgba(220, 195, 146, 1));" >
    ...
    <section class="content">
      ...
      <div class="row" style="color:black ; font-size: 17px; font-family:sans-serif">
        <div class="col-xs-12" >
          <h3> 
            <b>VOTES RESULT<span class="pull-right"></span></b> 
          </h3>
          <button onclick="window.print()" style="float:right;">Print The Result</button>
          <!-- <button onclick="printDiv('printableArea')">Print the result</button> -->
        </div>
