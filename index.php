...
<body>
	...
	<div class="login-box">
		...
		<!-- Admin Login Link -->
		<p class="admin-link" style="color:whitesmoke; text-align:center; margin-top: 10px;">Are you an
			admin? <a href="admin/login.php" style="color:#fc5c7d"><b>Log in here</b></a>.</p>


		<!-- Registration -->
		<p class="admin-link" style="color:whitesmoke; text-align:center; margin-top: 10px;">Haven't
			register yet? <a href="includes/register.php" style="color:#fc5c7d"><b>Register
					here</b></a>.</p>
